...
(function(C) {
  ...
  function ce(a, b) {
    ...
    "string" === typeof a && "$" === a.charAt(0) && "$" === a.charAt(1)
      ...
      : Va(b)
        ? d = "$WINDOW"
        : b && C.document === b ? d = "$DOCUMENT" : Ya(b) && (d = "$SCOPE");
    return d;
  }
  function bb(a, b) {
  ...
  function Ac(a) {
    ...
    q((a || "").split("&"), function(a) {
      var c, e, f;
      a &&
        (e = a = a.replace(/\+/g, "%20"), c = a.indexOf("="), -1 !== c &&
          (e = a.substring(0, c), f = a.substring(c + 1)), e = zc(e), w(e) &&
          (f = w(f) ? zc(f) : !0, ua.call(b, e)
            ? L(b[e]) ? b[e].push(f) : b[e] = [b[e], f]
            : b[e] = f));
    });
    return b;
  }
  ...
  function eb(a, b) {
    ...
    c &&
      (b
        ? delete c.data[b]
        : (c.handle &&
          (c.events.$destroy && c.handle({}, "$destroy"), Rc(
            a
  ...
  function xb(a, b) {
    ...
    b &&
      !d &&
      (a.ng339 = d = ++Pf, d = fb[d] = {events: {}, data: {}, handle: void 0});
    return d;
  }
  function Yb(a, b, d) {
    if (Nc(a)) {
    ...
    function g(a) {
      ...
      q(a, function(a) {
        ...
        if (!m.get(a)) {
          ...
          try {
            G(a)
              ? (c = Ub(a), b = b.concat(g(c.requires)).concat(c._runBlocks), d(
                c._invokeQueue
              ), d(c._configBlocks))
              : z(a)
                ? b.push(p.invoke(a))
                : L(a) ? b.push(p.invoke(a)) : Pa(a, "module");
          } catch (e) {
            throw (L(a) &&
              (a = a[a.length -
      ...
      if (b) {
        ...
        !c.history || h && f
          ? (h || (t = b), d
            ? l.replace(b)
            : h
              ? (d = l, e = b.indexOf("#"), e = -1 === e
                ? ""
                : b.substr(e), d.hash = e)
              : l.href = b, l.href !== b && (t = b))
      ...
      function(a, b, c, e, n, t, K, M, H, E) {
        ...
        function s(a, b, c, d, e, f) {
          function g(a, c, d, e) {
            ...
            m = 0;
            for (p = h.length; m < p; )
              k = v[h[m++]], c = h[m++], f = h[m++], c
                ? (c.scope
                  ? (l = a.$new(), aa.$$addScopeInfo(F(k), l))
                  : l = a, r = c.transcludeOnThisElement
                  ? za(a, c.transclude, e)
                  : !c.templateOnThisElement && e
                    ? e
                    : !e && b ? za(a, b) : null, c(f, l, k, d, r))
          ...
          switch (a.nodeType) {
            case 1:
              ...
              for (
                ...
                (g = g.match(Ca)) &&
                  V(g[1]) &&
                  (v = k, u = k.substr(0, k.length - 5) + "end", k = k.substr(
                    0,
                    k.length - 6
                  ));
                g = Aa(k.toLowerCase());
        ...
        function oa(a, b, d, e, f, g, h, k, l) {
          ...
          function p(a, e, f, g, l) {
            ...
            u &&
              (aa.$$addScopeInfo(
                ...
                I,
                !0
              ), M.$$isolateBindings = u.$$isolateBindings, E = ka(
                e,
                g,
                M,
                M.$$isolateBindings,
            ...
            for (n in t) {
              ...
              K !== x.instance &&
                (x.instance = K, I.data(
                  ...
                  x.bindingInfo.removeWatches(), x.bindingInfo = ka(
                  B,
                  g,
                  x.instance,
                  Zb,
          ...
          for (
            ...
            if (w = x.scope)
              x.templateUrl ||
                (D(w)
                  ...
                  : X("new/isolated scope", u, x, t)), r = r || x;
            I = x.name;
            if (
              !Fa &&
            ...
            if (w = x.transclude)
              if (
                (M = !0, x.$$tlb ||
                  (X("transclusion", E, x, t), E = x), "element" == w)
              )
                fa = !0, n = x.priority, P = t, t = d.$$element = F(
                  aa.$$createComment(I, d[I])
                ), b = t[0], ea(
                  f,
                  va.call(P, 0),
                  b
                ), P[0].$$parentNode = P[0].parentNode, K = ac(
                  za,
                  P,
                  e,
                  n,
            ...
            if (x.template)
              if (
                (B = !0, X("template", H, x, t), H = x, w = z(x.template)
                  ? x.template(t, d)
                  : x.template, w = xa(w), x.replace)
              ) {
                g = x;
                ...
                t.html(w);
            if (x.templateUrl)
              B = !0, X("template", H, x, t), H = x, x.replace &&
                (g = x), p = ba(
        ...
        function ba(a, b, c, d, f, g, h, k) {
          ...
          return function(a, b, c, d, e) {
            ...
            b.$$destroyed ||
              (l
                ? l.push(b, c, d, a)
                : (m.transcludeOnThisElement && (a = za(b, m.transclude, e)), m(
                  p,
                  b,
                  c,
                  d,
        ...
        function ka(a, c, d, e, f) {
          function g(b, c, e) {
            z(d.$onChanges) &&
              c !== e &&
              (Y || (a.$$postDigest(I), Y = []), m ||
                (m = {}, Y.push(h)), m[b] &&
                (e = m[b].previousValue), m[b] = new Fb(e, c));
          }
          function h() {
            d.$onChanges(m);
            m = void 0;
      ...
      function(d, c) {
        ...
        return function(f, g, h, k) {
          ...
          if (h)
            return h = (L(f)
              ? f[f.length - 1]
              : f).prototype, l = Object.create(h || null), n &&
              e(g, n, l, m || f.name), S(
              function() {
        ...
        function n(c, d) {
          ...
          E &&
            (I = E.get(P), w(I)
              ? I && z(I.then)
                ? I.then(t, t)
                : L(I) ? n(I[1], I[0], ia(I[2]), I[3]) : n(I, 200, {}, "OK")
              : E.put(P, H));
          y(I) &&
            ((I = id(c.url)
              ? f()[c.xsrfCookieName || a.xsrfCookieName]
              : void 0) &&
              (Da[c.xsrfHeaderName || a.xsrfHeaderName] = I), e(
              c.method,
              P,
              d,
              l,
        ...
        function k(f, k, p, n) {
          ...
          if (!f.length || -1 === f.indexOf(a)) {
            ...
            k ||
              (k = g(f), v = ha(
                k
              ), v.exp = f, v.expressions = [], v.$$watchDelegate = h);
            return v;
          }
          n = !!n;
          var q, t, K = 0, M = [], H = [];
          ...
          for (var E = [], I = []; K < v; )
            if (-1 != (q = f.indexOf(a, K)) && -1 != (t = f.indexOf(b, q + l)))
              K !== q && E.push(g(f.substring(K, q))), K = f.substring(
                q + l,
                t
              ), M.push(K), H.push(d(K, J)), K = t + m, I.push(
                E.length
              ), E.push("");
            else {
      ...
      function(a, b, d, c, e) {
        ...
        f.cancel = function(a) {
          return a && a.$$intervalId in g
            ? (g[a.$$intervalId].reject("canceled"), b.clearInterval(
              a.$$intervalId
  ...
  function sf() {
    ...
    this.html5Mode = function(a) {
      return Ga(a)
        ? (b.enabled = a, this)
        : D(a)
          ? (Ga(a.enabled) && (b.enabled = a.enabled), Ga(a.requireBase) &&
            (b.requireBase = a.requireBase), Ga(a.rewriteLinks) &&
            (b.rewriteLinks = a.rewriteLinks), this)
          : b;
    };
    this.$get = [
      "$rootScope",
        ...
        d.$watch(function() {
          ...
          if (q || m) q = !1, d.$evalAsync(function() {
              ...
              l.absUrl() === b &&
                (c
                  ? (l.$$parse(a), l.$$state = f)
                  : (m && h(b, g, f === l.$$state ? null : l.$$state), k(
                    a,
                    f
                  )));
            });
      ...
      function(f) {
        ...
        function u(a, b) {
          ...
          a.$$watchDelegate && a.$$watchDelegate !== l
            ...
            : b.$stateful ||
              (c.$$watchDelegate = l, d = !a.inputs, c.inputs = a.inputs
                ? a.inputs
                : [a]);
          return c;
        }
    ...
    S(f.prototype, {
      ...
      $$resolve: function(a) {
        ...
        try {
          ...
          z(g)
            ? (this.promise.$$state.status = -1, g.call(
              a,
              d,
              f,
              c(this, this.notify)
            ))
            : (this.promise.$$state.value = a, this.promise.$$state.status = 1, e(
              this.promise.$$state
            ));
        } catch (l) {
          f(l), b(l);
  ...
  function vf() {
    ...
    this.$get = [
      ...
      function(f, g, h) {
        ...
        function l(a) {
          9 === Ea &&
            (a.$$childHead && l(a.$$childHead), a.$$nextSibling &&
              l(a.$$nextSibling));
              ...
              if (!y(e)) {
                if (D(e))
                  if (ta(e))
                    for (
                      f !== n &&
                        (f = n, u = f.length = 0, l++), a = e.length, u !== a &&
                        (l++, f.length = u = a), b = 0;
                      b < a;
                      b++
                    )
                ...
                if (p = t.$$watchers) for (u = p.length; u--; ) try {
                      if (a = p[u])
                        if (
                          ...
                          r = !0, c = a, a.last = a.eq
                            ? pa(g, null)
                            : g, l = a.fn, l(g, k === s ? g : k, t), 5 > q &&
                            (A = 4 - q, y[A] || (y[A] = []), y[A].push({
                              msg: z(a.exp)
  ...
  function La(a, b, d, c, e, f) {
    ...
    switch (g) {
      case "object":
        var k;
        if (e) {
          for (k in a) if ("$" !== k.charAt(0) && La(a[k], b, d, c, !0))
              return !0;
  ...
  function xg(a, b, d, c) {
    ...
    if (0 < d) {
      ...
      for (var g = d; g < e.length; g++) e[g] = 0;
        ...
        f = Math.max(0, f), a.i = 1, e.length = Math.max(
          1,
          d = b + 1
        ), e[0] = 0, g = 1;
        g < d;
  ...
  function sg() {
    return function(a, b, d) {
      ...
      return 0 <= b
        ? oc(a, d, d + b)
        : 0 === d ? oc(a, b, a.length) : oc(a, Math.max(0, d + b), d);
    };
  }
  function oc(a, b, d) {
  ...
  function Kd(a) {
    ...
    c.$setValidity = function(a, e, f) {
      y(e)
        ...
        : (c.$pending && h(c.$pending, a, f), Pd(c.$pending) &&
          (c.$pending = void 0));
      Ga(e)
        ? e
  ...
  var L = Array.isArray,
    ...
    rb = function() {
      ...
      for (b = 0; b < d; ++b)
        if (
          (c = Na[b], a = C.document.querySelector(
            "[" + c.replace(":", "\\:") + "jq]"
          ))
        ) {
  ...
  q(
    {
      ...
      inheritedData: Cb,
      scope: function(a) {
        return F.data(a, "$scope") ||
          Cb(a.parentNode || a, ["$isolateScope", "$scope"]);
      },
      isolateScope: function(a) {
        return F.data(a, "$isolateScope") ||
        ...
        if (Nc(a)) {
          ...
          for (var g = c.length,
              h = function(b, c, g) {
                var h = e[b];
                h ||
                  (h = e[b] = [], h.specialHandlerWrapper = c, "$destroy" ===
                    b ||
                    g ||
          ...
          return {
            ...
            push: function(g, h, k, l) {
              ...
              if (k.addClass || k.removeClass)
                if (
                  (h = k.addClass, l = k.removeClass, k = a.get(g) || {}, h = e(
                    k,
                    h,
                    !0
                  ), l = e(k, l, !1), h || l)
  ...
  jc.prototype = {
    ...
    readString: function(a) {
      ...
      for (var d = "", c = a, e = !1; this.index < this.text.length; ) {
        ...
        if (e)
          "u" === f
            ? (e = this.text.substring(this.index + 1, this.index + 5), e.match(
              /[\da-f]{4}/i
            ) ||
              this.throwError(
  ...
  td.prototype = {
    compile: function(a, b) {
      ...
      this.stage = "assign";
      if (f = rd(c))
        this.state.computing = "assign", e = this.nextId(), this.recurse(
          f,
          e
        ), this.return_(e), e = "fn.assign=" +
      ...
      if (!f && w(a.watchId))
        ...
        switch (a.type) {
              ...
              function() {
                k.if_(
                  ...
                  function() {
                    ...
                    if (a.computed)
                      h = k.nextId(), k.recurse(
                        a.property,
                        h
                      ), k.getStringValue(h), k.addEnsureSafeMemberName(h), e &&
                        1 !== e &&
                        k.if_(
                      ...
                      ), k.assign(b, m), d && (d.computed = !0, d.name = h);
                    else {
                      Sa(a.property.name);
                      e &&
                        1 !== e &&
          ...
          case s.CallExpression:
            b = b || this.nextId();
            a.filter
              ? (h = k.filter(a.callee.name), l = [], q(a.arguments, function(
                a
              ) {
                var b = k.nextId();
                k.recurse(a, b);
                    ...
                    function() {
                      ...
                      g.name
                        ? (k.state.expensiveChecks ||
                          k.addEnsureSafeObject(g.context), m = k.member(
                          g.context,
                          g.name,
                          g.computed
                        ) +
          ...
          case s.ObjectExpression:
            ...
            n
              ? (b = b || this.nextId(), this.assign(
                b,
                "{}"
              ), q(a.properties, function(a) {
                a.computed
                  ? (g = k.nextId(), k.recurse(a.key, g))
                  : g = a.key.type === s.Identifier
                    ? a.key.name
                    : "" + a.key.value;
                h = k.nextId();
                k.recurse(a.value, h);
  ...
  ud.prototype = {
      ...
      switch (a.type) {
        ...
        case s.MemberExpression:
          return c = this.recurse(
            ...
            !1,
            !!d
          ), a.computed || (Sa(a.property.name, f.expression), e = a.property.name), a.computed && (e = this.recurse(a.property)), a.computed ? this.computedMember(c, e, b, d, f.expression) : this.nonComputedMember(c, e, f.expensiveChecks, b, d, f.expression);
        case s.CallExpression:
          return g = [], q(a.arguments, function(a) {
            ...
            (e = this.$filter(
              a.callee.name
            )), a.filter || (e = this.recurse(a.callee, !0)), a.filter ? (function(a, c, d, f) {
              for (
                var n = [], p = 0;
                p < g.length;
                ++p
        ...
        case s.AssignmentExpression:
          return c = this.recurse(
            ...
            !0,
            1
          ), e = this.recurse(a.right), function(a, d, g, m) {
            var n = c(a, d, g, m);
            a = e(a, d, g, m);
    ...
    computedMember: function(a, b, d, c, e) {
      return function(f, g, h, k) {
        var l = a(f, g, h, k), m, n;
        null != l &&
          (m = b(f, g, h, k), m += "", Sa(m, e), c &&
            1 !== c &&
            (Ib(l), l && !l[m] && (l[m] = {})), n = l[m], ra(n, e));
            ...
            return {
              pre: function(a, d, e, f) {
                ...
                g && (q(a, n), e.$observe(g, function(b) {
                    n.$name !== b &&
                      (q(a, void 0), n.$$parentForm.$$renameControl(
                        n,
                        b
                      ), q = c(n.$name), q(a, n));
                  }));
        ...
        if (G(a)) {
          ...
          if (d) {
            var c = +d[1],
              ...
              e = 7 * (e - 1);
            b &&
              (d = b.getHours(), f = b.getMinutes(), g = b.getSeconds(), h = b.getMilliseconds());
        ...
        link: function(d, c, e, f, g) {
          ...
          d.$watch(e.ngIf, function(d) {
            d ? k || g(function(d, f) {
                ...
                (l.remove(), l = null), k && (k.$destroy(), k = null), h && (l = tb(h.clone), a.leave(l).then(function() {
                  l = null;
                }), h = null));
          });
        }
        ...
        return {
          ...
          link: function(b, d, c, e) {
            ma.call(d[0]).match(/SVG/)
              ? (d.empty(), a(
                Oc(e.template, C.document).childNodes
              )(
                b,
                function(a) {
                  d.append(a);
      ...
      function(a, b, d, c, e, f, g, h, k, l) {
        ...
        this.$validate = function() {
          if (!T(r.$modelValue) || !isNaN(r.$modelValue)) {
            ...
            r.$$runValidators(a, r.$$lastCommittedViewValue, function(e) {
              d ||
                b === e ||
                (r.$modelValue = e ? a : void 0, r.$modelValue !== c &&
                  r.$$writeModelToScope());
            });
          }
        };
        ...
        this.$commitViewValue = function() {
          ...
          if (
            ...
            r.$$updateEmptyClasses(
              a
            ), r.$$lastCommittedViewValue = a, r.$pristine &&
        ...
        this.$$parseAndValidate = function() {
          ...
          r.$$rawModelValue = b;
          e &&
            (r.$modelValue = b, r.$modelValue !== d && r.$$writeModelToScope());
          r.$$runValidators(b, r.$$lastCommittedViewValue, function(a) {
            e ||
              (r.$modelValue = a ? b : void 0, r.$modelValue !== d &&
                r.$$writeModelToScope());
          });
        };
        ...
        this.$$debounceViewValueCommit = function(b) {
          ...
          d &&
            ...
            (d = d.debounce, T(d)
              ? c = d
              : T(d[b]) ? c = d[b] : T(d["default"]) && (c = d["default"]));
          g.cancel(s);
          c ? s = g(
              function() {
                r.$commitViewValue();
              ...
              c
            ) : h.$$phase ? r.$commitViewValue() : a.$apply(function() {
                r.$commitViewValue();
              });
        };
        a.$watch(function() {
          var b = p(a);
          if (
            b !== r.$modelValue && (r.$modelValue === r.$modelValue || b === b)
          ) {
            ...
            r.$viewValue !== e &&
              (r.$$updateEmptyClasses(
                e
              ), r.$viewValue = r.$$lastCommittedViewValue = e, r.$render(), r.$$runValidators(
                b,
                e,
                A
              ));
        ...
        controller: [
          ...
          function(a, b) {
            ...
            w(this.$options.updateOn)
              ? (this.$options.updateOnDefault = !1, this.$options.updateOn = W(
              ...
              function n() {
                ...
                t.items.forEach(function(a) {
                  ...
                  if (w(a.group)) {
                    b = d[a.group];
                    b ||
                      (b = f.cloneNode(!1), C.appendChild(b), b.label = null ===
                        a.group
                        ? "null"
                        : a.group, d[a.group] = b);
                    var c = e.cloneNode(!1);
                ...
                s.$render();
                s.$isEmpty(a) ||
                  (b = p.readValue(), (K.trackBy || y ? na(a, b) : a === b) ||
                    (s.$setViewValue(b), s.$render()));
              }
              var p = l[0], s = l[1], y = k.multiple, B;
              l = 0;
              for (
                var r = h.children(), A = r.length;
                l < A;
                l++
              ) if ("" === r[l].value) {
                  B = r.eq(l);
              ...
              y ? (s.$isEmpty = function(a) {
                  ...
                  b
                    ? (h[0].value !== b.selectValue &&
                      (z.remove(), v ||
                        B.remove(), h[0].value = b.selectValue, b.element.selected = !0), b.element.setAttribute(
                      "selected",
                      "selected"
                    ))
                    : null === a || v
                      ? (z.remove(), v || h.prepend(B), h.val(""), B.prop(
                        "selected",
                        !0
                      ), B.attr("selected", !0))
                      : (v || B.remove(), h.prepend(z), h.val("?"), z.prop(
                        "selected",
                        !0
                      ), z.attr("selected", !0));
                }, p.readValue = function() {
            ...
            return function(a, d, f, g, l) {
              ...
              a.$watchCollection(n, function(f) {
                ...
                if (ta(f)) G = f, n = z || v;
                    ...
                    A, G = [], f)) ua.call(f, H) && "$" !== H.charAt(0) && G.push(H);
                t = G.length;
                H = Array(t);
                for (
                  g = 0;
    ...
    Vg = [
      ...
      function(a, b) {
        ...
        d.writeValue = function(b) {
          d.hasOption(b)
            ? (d.removeUnknownOption(), a.val(b), "" === b &&
