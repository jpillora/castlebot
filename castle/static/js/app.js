...
module.controller('CamController', function($scope, $http) {
  ...
  var rangeChange = cam.rangeChange = function() {
    ...
    if(cam.timeIndex === "1000") {
      ...
      var past = moment();
      switch(cam.range) {
      case "month": past.subtract(31, "day"); break;
      case "week": past.subtract(7, "day"); break;
      case "day": past.subtract(1, "day"); break;
      case "hour": past.subtract(1, "hour"); break;
      }
